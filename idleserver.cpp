...
int main()
{
	...
	// Server Status
    const unsigned char serverPortsC = 13;
    unsigned short serverPorts[serverPortsC] = { 21, 22, 25, 53, 80, 443, 110, 143, 2083, 2087, 2096, 3306, 5432 };
    enum serverPortsK {
        spHTTP = 3,
        spCPANEL = 7,
        spWHM = 8,
	...
	while(true){
        ...
        curl_easy_setopt(curl, CURLOPT_URL, "https://idleserv.net/network/ping");
